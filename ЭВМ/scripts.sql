...
INSERT INTO zakaz VALUES('4001', '2023-06-24', '2023-07-01', '200', '1015', '3004');
INSERT INTO zakaz VALUES('4002', '2023-04-14', '2023-04-17', '2341', '1005', '3001');
INSERT INTO zakaz VALUES('4003', '2023-09-13', '2023-09-15', '20000', '1014', '3010');
INSERT INTO zakaz VALUES('4004', '2023-06-21', '2023-06-25', '10000', '1010', '3007');
INSERT INTO zakaz VALUES('4005', '2023-01-09', '2023-01-09', '61', '1001', '3009');
INSERT INTO zakaz VALUES('4006', '2023-01-21', '2023-01-28', '2100', '1007', '3009');
INSERT INTO zakaz VALUES('4007', '2023-08-03', '2023-08-20', '1000', '1003', '3009');
INSERT INTO zakaz VALUES('4008', '2023-03-02', '2023-03-16', '5500', '1004', '3006');
INSERT INTO zakaz VALUES('4009', '2023-07-19', '2023-07-24', '10', '1010', '3005');
INSERT INTO zakaz VALUES('4010', '2023-05-24', '2023-05-29', '10000', '1013', '3008');
INSERT INTO zakaz VALUES('4011', '2023-04-21', '2023-04-26', '10000', '1014', '3008');
INSERT INTO zakaz VALUES('4012', '2023-02-10', '2023-02-15', '1000', '1003', '3002');
INSERT INTO zakaz VALUES('4013', '2023-08-09', '2023-08-29', '20000', '1014', '3010');
INSERT INTO zakaz VALUES('4014', '2023-09-23', '2023-10-05', '666', '1006', '3003');
INSERT INTO zakaz VALUES('4015', '2023-04-25', '2023-04-30', '3000', '1009', '3007');
SELECT * FROM zakaz;
...
-- 5 задание
SELECT ID_Zakaz, Date_vipolnenia, Count_exemplyars FROM zakaz WHERE Date_vipolnenia LIKE '2023-01-%' AND Count_exemplyars BETWEEN 1000 AND 9999;
...
HAVING sum(Count_exemplyars) > avg(Count_exemplyars);
...
/*SELECT whriter.Surname, book.Name_book, zakaz.ID_Zakaz, zakazchik.Name_zakazchik
FROM whriter
LEFT JOIN book_has_whriter ON whriter.Number_passport = book_has_whriter.Whriter_Number_passport
LEFT JOIN book ON book_has_whriter.ID_book = book.ID_book
LEFT JOIN zakaz ON zakaz.Book_ID_book = book.ID_book
LEFT JOIN zakazchik ON zakaz.Zakazchik_ID_zakazchika = zakazchik.ID_zakazchika
UNION
SELECT whriter.Surname, book.Name_book, zakaz.ID_Zakaz, zakazchik.Name_zakazchik
FROM whriter
RIGHT JOIN book_has_whriter ON whriter.Number_passport = book_has_whriter.Whriter_Number_passport
RIGHT JOIN book ON book_has_whriter.ID_book = book.ID_book
RIGHT JOIN zakaz ON zakaz.Book_ID_book = book.ID_book
RIGHT JOIN zakazchik ON zakaz.Zakazchik_ID_zakazchika = zakazchik.ID_zakazchika;*/